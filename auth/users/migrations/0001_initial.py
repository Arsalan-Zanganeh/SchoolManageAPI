...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('HomeWorkQuestions', models.FileField(blank=True, null=True, upload_to='profile_image/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Mode', models.CharField(choices=[('created', 'Created'), ('started', 'Started'), ('finished', 'Finished')], max_length=20)),
                ('Classes', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.classes')),
                ('Teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.teacher')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('OpenTime', models.DateTimeField()),
                ('CloseTime', models.DateTimeField()),
                ('Mode', models.CharField(choices=[('not_started', 'Not_Started'), ('started', 'Started'), ('continue', 'Continue'), ('finished', 'Finished')], max_length=20)),
                ('QuizTeacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.quizteacher')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('OnParticipation', models.IntegerField()),
                ('QuizStudent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.quizstudent')),
            ],
            options={
