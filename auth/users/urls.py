...
from .views import RegisterView, LoginView, UserView, LogoutView, AddStudentView, AddTeacherView, AddSchoolView, \
    ...
    QuizQuestionStudentView, QuizFinishedBoolean, NotificationStudentSingleSeen, SchoolTeachersView, TeacherIdtoInfo
...
urlpatterns = [
    ...
    path('prinicipal-google-calendar/', PrinicipalCalendarView.as_view()),
